...
void Obstacle(void)
{
  ...
  switch (turn)
  {
    case 0:
      {
        if (encoderPos >= 500) // 실험 통해
        {
          reset_encoder();
          steering_control(50); // 실험 통해
          turn = 1;
        }
      }
      break;
...
void loop()
{
  ...
  switch (mission_flag)
  {
    ...
    case 2:
      ...
      motor_control(165);
      wall_following();
      if (UltrasonicSensorData[0] <= 1290)
      {
        motor_control(0);
        steering_control_0();
        delay(10);
    ...
    case 4:
      ...
      if (encoderPos >= 2500)
      {
        if (UltrasonicSensorData[0] <= 1370)
        {
          motor_control(0);
          steering_control_0();
          delay(10);
